...
import com.lduran.algafood.api.assembler.PermissaoModelAssembler;
import com.lduran.algafood.api.model.PermissaoModel;
...
public class GrupoPermissaoController
{
	...
	public ResponseEntity<List<PermissaoModel>> listar(@PathVariable Long grupoId)
	{
		...
		return ResponseEntity.ok(assembler.toCollectionModel(grupo.getPermissoes()));
	}
